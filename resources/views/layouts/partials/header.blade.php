    ...
    <nav class="navbar navbar-default rounded bg-info w-100 p-3 fixed-top vh-md-100 animate__animated animate__backInDown">
        <div class="container-fluid">
          ...
          <div id="iconsvg" class="d-flex position-absolute ">
            ...
            <a class="rounded-circle" href="{{route('home.create')}}"> 
            ...
            <button class="btn success rounded-circle" onclick="location.href='{{route('auth.edit', auth()->user()->id)}}'"><img src="{{asset('img/profile/profile.png')}}" ></button>
          </div>
        </div>
    </nav>
